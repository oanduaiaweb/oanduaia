...
const RAW_2026: [string, string, string, string][] = [
  ...
  ['valikook-istumine', 'Tume puidust laud ja pingid paekivisel terrassil, kuused ja kasvuhoone taga', 'A dark timber table and benches on the flagstone terrace, spruces and the greenhouse beyond', 'Тёмный деревянный стол и скамьи на каменной террасе, ели и теплица позади'],
  ['valikook', 'Pikk puidust laud väliköögi katuse all, muru ja maja taga', 'The long timber table under the outdoor kitchen roof, lawn and house beyond', 'Длинный деревянный стол под крышей летней кухни, газон и дом позади'],
