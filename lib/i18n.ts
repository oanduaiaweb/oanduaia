...
export const FAQ: Record<Lang, [string, string][]> = {
  et: [
    ...
    ['Kas lisavoodeid saab?',
     'Jah. Lehel olevad arvud – Saunamaja viiele, Metsamaja neljale, Tiigimaja kahele – on see, mitu inimest maja tavapäraselt magab. Lisamagamiskohti saab kokku leppida; kirjuta info@oanduaia.ee ja ütleme, mis millisesse majja sobib.'],
  ...
  en: [
    ...
    ['Can you add extra beds?',
     'Yes. The numbers on this site — five in the Sauna House, four in the Forest House, two in the Pond House — are what each house sleeps as standard. Further sleeping places can be arranged; write to info@oanduaia.ee and we will tell you what fits which house.'],
    ['Are pets allowed?',
  ...
  ru: [
    ...
    ['Можно ли добавить кровати?',
     'Да. Числа на сайте — пять в Банном доме, четыре в Лесном, двое в Прудовом — это стандартная вместимость каждого дома. Дополнительные спальные места можно согласовать; напишите на info@oanduaia.ee, и мы скажем, что подойдёт для какого дома.'],
