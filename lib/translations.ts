...
export const T = {
  ...
  services: {
    ...
    s2: {
      t1: { et: 'Pidulik pikk laud', en: 'Festive table', ru: 'Праздничный стол' },
      t2: { et: 'Välisköök', en: 'Outdoor kitchen', ru: 'Летняя кухня' },
      desc: {
        et: 'Ette tellides kahele kuni kümnele. Suvel väliköögis kuni kahekümne inimesele.',
        en: 'Pre-ordered for two to ten people. In summer, the outdoor kitchen serves up to twenty.',
        ru: 'По предварительному заказу для двух–десяти человек. Летом на открытой кухне — до двадцати.',
      },
    },
    s3: {
      t1: { et: 'Perenaise', en: "Host's", ru: 'Хозяйский' },
      t2: { et: 'Laud', en: 'Table', ru: 'Стол' },
      desc: {
        et: 'Kodusem supilõuna või pidulikum pikk laud - kõik maitsed pärit lähiümbruse põldudelt ja aedadest.',
        en: 'A homier soup lunch or a more festive long table - all flavours from nearby fields and gardens.',
        ru: 'Домашний суп-обед или более торжественный стол — все вкусы из ближних полей и огородов.',
      },
    },
  },
  feature: {
    ...
    i1:   { et: 'Saunamaja — kuni 5 ööbijat, 2 korrust', en: 'Sauna house — up to 5 guests, 2 floors', ru: 'Банный дом — до 5 гостей, 2 этажа' },
    i2:   { et: 'Avatud road, puuküttega saun, täisvarustatud köök', en: 'Open terrace, wood-fired sauna, fully equipped kitchen', ru: 'Открытая терраса, дровяная сауна, оборудованная кухня' },
    i3:   { et: 'Tiigimaja — kahele (+lisavoodi), suur terrass, kamin', en: 'Pond house — for two (+extra bed), large terrace, fireplace', ru: 'Прудовой дом — для двоих (+доп. кровать), терраса, камин' },
    i4:   { et: 'Eraldi magamistuba teisel korrusel, kööginurk, vannituba', en: 'Separate bedroom on second floor, kitchenette, bathroom', ru: 'Отдельная спальня на втором этаже, кухонный угол, ванная' },
    i5:   { et: 'Metsamaja — neljale, 2 magamistuba (180 cm voodid)', en: 'Forest house — for four, 2 bedrooms (180 cm beds)', ru: 'Лесной дом — на четверых, 2 спальни (кровати 180 см)' },
    i6:   { et: 'Kamin, mini köök, WC ja dušš', en: 'Fireplace, mini kitchen, WC and shower', ru: 'Камин, мини-кухня, туалет и душ' },
